...
permissive and AGPL-compatible. When an embedding model is bundled for this
feature it will be the MIT-licensed BAAI/bge-small-en-v1.5, redistributed under
its own MIT terms with attribution.
