...
static TOOLS: &[ToolSpec] = &[
    ...
    ToolSpec { name: "ci-check",   description: "Full CI gates: build, test, lint, check.",                                                                     args: &[("path", "string"), ("severity", "string")] },
    ...
    ToolSpec { name: "workflow",   description: "Instantiate templates with substitutions.",                                                                  args: &[("template", "string"), ("output", "string")] },
    ToolSpec { name: "query-adq",  description: "Execute an Aden Query (.adq) script.",                                                                       args: &[("script", "string"), ("path", "string")] },
    ToolSpec { name: "watch",      description: "Watch source files and auto-regenerate contracts.",                                                            args: &[("path", "string"), ("sync", "boolean")] },
    ...
    ToolSpec { name: "emergency",  description: "Downgrade Forbid policies to Warn with justification.",                                                       args: &[("reason", "string"), ("path", "string")] },
